...
## Summary
- `test` 配下で `acp_builder` の正本 schema 参照用 path helper を集める補助対象である。テストから oracle 側の `acp_builder` 定義へ直接つなぐ必要があるときの入口になる。
...
## hash
- d0fad550db1f78b1358fa760e18e40d92b5508517cf5c38c6308eb873941b047
