...
## Summary
- `test` 配下で `acp_builder` の正本 schema を参照するための共通 path helper を扱う補助対象。テスト側で schema を複製せず、oracle 側の `acp_builder` 定義へ直接つなぐ必要があるときの入口にする。
...
## hash
- 60976deb8b299cee11e19f5eb37493eab997363b0a8206e4d61a26ab286e597f
