...
## Summary
- 日本語の技術文書として、指定された `oracle` 配下の正本文書を分類し、CLI・workflow の挙動仕様、Git の branch／commit／worktree モデル、開発・テスト規則、検討資料へ進むための最上位ルーティング入口を示す。
- 配下の個別文書を直接読むべき作業と、`oracle` 全体の責務や下位領域の選択を確認するために読むべき作業を切り分ける。
...
## hash
- 1f6017a32f8bc76512737870529398ba5ca0db1e1b908429dce6ff6f24c93201
