...
## Summary
- `oracle/doc` 配下の正本仕様断片へ進むための入口。CLI 全体に関わる横断仕様をまとめており、起動前処理・補完・ログ・エラー・実行隔離・セッション状態・外部 provider 境界のような共通論点を先に切り分けたいときに読む。個別サブコマンドの詳細を追う前に、どの仕様断片へ進むべきかを判断する役割が中心。
...
## hash
- 8a7bb976981a8f2a3e2074ea4366da69ca99796bbc20ce2a177f264c6b1260d7
