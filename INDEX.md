...
## Summary
- cmoc の正本文書群を分野別に案内する入口です。アプリケーション挙動、branch・commit・worktree のモデル、採用しなかった代替案、開発ルールを扱い、個別の確認や変更では対応する下位文書へ進みます。
- 現行仕様、設計・実装配置、開発環境、テスト要件・実行手順、不採用案の背景を確認する際の領域横断的なルーティング起点です。詳細な契約や手順は下位文書を参照してください。
...
## hash
- 65cd488baa4ce59649176ecbd0ac6a31e26769ff36d612d9f3dc8816f8784335
