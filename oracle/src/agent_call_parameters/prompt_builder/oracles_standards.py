...
def build_oracle_standards() -> StructDoc:
    """
    ...
    standards = [
        ...
        Standard(
            title="ベストプラクティスよりも oracle standards で定義されている要求が優先される",
            targets=[
                "oracle file",
                "oracle standards の解釈",
                "cmoc による oracle file 支援機能",
            ],
            backgrounds=[
            ...
            requirements=[
                Requirement(
                    "必須",
                    "一般的に知られているベストプラクティスと oracle standards の要求が競合した場合は、oracle standards を優先する",
                ),
                Requirement(
                    "必須",
                    "一般的に知られているベストプラクティスを理由に、oracle standards の要求を無視してはいけない",
                ),
            ],
            criteria=[
                "判断の根拠が、一般論ではなく oracle standards と正本仕様断片に置かれている",
                "ベストプラクティスを採用する場合でも、oracle standards と矛盾していない",
            ],
            examples=[
                "OK: 一般には網羅的な仕様書が望ましい場面でも、oracle standards が疎な正本仕様断片を求めるなら疎に保つ",
