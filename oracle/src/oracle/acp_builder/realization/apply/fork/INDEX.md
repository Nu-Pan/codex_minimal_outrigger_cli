...
- 差分追従 Agent のモデル、推論品質、realization 書き込み権限、全体調査・検証・routing 方針などの起動条件を定める。realization apply fork の起動方法や、oracle file の変更を realization file へ反映する処理を確認する際の入口。
...
## hash
- d1d057d88fce823711be4360302c738043de6e1d6311adaa87da34c6ae403e44
