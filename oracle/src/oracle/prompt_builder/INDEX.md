...
## Summary
- エディタ経由で後続 AI エージェントへ渡すユーザー入力ファイルの初期テキストを構築する。使い方、プロンプト記入ガイドライン、完全プロンプトのテンプレートを構造化文書として HTML コメント内にまとめる。

## Read this when
- エディタ経由プロンプト入力の初期内容、記入ガイドライン、または `{{original-prompt-here}}` へのテンプレート挿入を確認・変更するとき。

## Do not read this when
- エディタ入力以外のプロンプト生成や、構造化文書の一般的なレンダリング仕様だけを確認するとき。

## hash
- 6330e8951ab5d668ab3850b9184f04738cda401548e04c75c7c3841a5b752fa0
