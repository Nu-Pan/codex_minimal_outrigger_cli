...
def build_oracle_policy() -> tuple[PlaceholderMap, SDHeader]:
    ...
    NOTE
        意味仕様は `oracle/doc/app_spec/oracle_and_realization.md:64` の
        「oracle file を扱う判断基準」と `oracle/doc/app_spec/codex_exec_rule.md:188` の
        ...
        SDHeader(
            ...
            SDPolicy(
                ...
                require=(
                    ...
                    "合わせて読む必要がある oracle file が存在する場合、それへの参照 (パス・行・簡潔な内容) を示すこと",
