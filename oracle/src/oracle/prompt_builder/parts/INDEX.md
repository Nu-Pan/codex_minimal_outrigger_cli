...
## Summary
- `realization standard` を組み立てる入口。realization file 全般の規範として、総文字数の抑制、重複や旧仕様向け実装の削除、コメントや docstring に残すべき意図、責務ごとの分割、抽象化の追加条件、公開面や永続状態の増加抑制、テストや補助ファイルの肥大化抑制をまとめて扱う。
- この対象を読むと、現行仕様を満たす最小で保守しやすい realization を作るために、どの変更を整理対象として見てよいか、またどこから先は新しい公開面や移行コードを増やさないべきかを判断しやすくなる。
...
## Do not read this when
- oracle file 自体の責務、正本仕様断片の扱い、人間判断と AI 裁量の境界を確認したいだけのとき。
- 基本的な oracle / realization の定義だけを確認したいときは、より基礎的な概念説明を読む方が直接的なとき。
...
## hash
- 1e87daf50e132ee01acc01713a61faf0e134ed66357bcf585875a8fa5c4b2d75
