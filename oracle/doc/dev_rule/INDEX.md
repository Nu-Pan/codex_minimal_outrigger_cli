...
## Summary
- cmoc の Python 実装に適用するコーディング規則を定める。PEP 8、命名・責務・入出力、コメントと docstring、型ヒント、import、識別子の可視性、最小限の実装方針などを扱う。実装やレビューで規約の適用範囲を確認する際の入口となる。

## Read this when
- cmoc の実装コードを作成・変更・レビューするとき
- 型ヒント、import、docstring、コメント、命名、cwd 識別子などのコーディング方針を確認するとき

## Do not read this when
- テスト固有の設計・実行方法を確認したいとき
- CLI の責務境界や実装配置を確認したいとき
- Python 環境や依存関係の構築方法だけを確認したいとき

## hash
- da30cc25ed8cf09839020472e0b1f0b27906aee47e2980bebcaa886fa41669e9
