...
- 正確な prompt 文面、prompt part の選択、起動パラメータ、および選択理由は、`oracle/src/oracle/acp_builder/session/join/conflict_resolution.py:27` の `build_session_join_conflict_resolution_parameter` へ委譲する
