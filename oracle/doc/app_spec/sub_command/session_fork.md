...
6. `{{cmoc-root}}/oracle/doc/app_spec/session_state.md` の「概要」と同文書の schema に従って、session 情報と初期状態を保存する
...
- report は Markdown と YAML Front Matter で構成し、`{{repo-root}}/.cmoc/gu/report/session/fork/{{time-stamp}}.md` に保存する。
