...
- TUI の意味上の責務と起動条件は本書を正本とする。正確な prompt part の選択、文面、起動パラメータ、および選択理由は、`oracle/src/oracle/acp_builder/tui/launch_tui.py:15` の `build_tui_launch_tui_parameter` へ委譲する
