...
## Summary
- cmoc のアプリ全体に関わる正本仕様断片群への入口。CLI 起動前処理、補完、ログ、エラー、サブコマンド入口、実行隔離、セッション状態、外部 model/provider 境界、利用手順など、個別実装に進む前に読むべき横断仕様をまとめている。
- この配下は、個別サブコマンドの詳細よりも、どの仕様断片を先に読むべきかを切り分けるために使う。
...
## hash
- 9df38bb7eab0c52d1d8a1a92b306bfc5544d229bd9a619b726c54fad919fdba5
