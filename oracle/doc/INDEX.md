...
## Summary
- cmoc のアプリケーション仕様を分野別にまとめた正本文書群。自動補完、managed ollama、Codex CLI 呼び出し、ログ、doctor、エラー処理、プロンプト、run 隔離、session 状態、主要サブコマンド、利用手順などの仕様入口を提供する。

## Read this when
- cmoc の個別機能や共通アプリケーション仕様について、実装・変更・レビュー・検証の開始点を選びたいとき。
- 対象機能の正本仕様文書や、その下位サブコマンド仕様を特定したいとき。

## Do not read this when
- 実装ファイルの具体的な処理やテスト方法だけを確認したいときは、対応する realization code または開発ルールを直接読む。
- 既に対象仕様が特定できており、他分野のアプリケーション仕様を横断的に探す必要がないとき。

## hash
- 13e0d4851007af1942ec44ddc4de4ab88c7b02ede91f09b1d8438f0b5925085a
