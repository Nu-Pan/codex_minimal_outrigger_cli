...
## Summary
- アプリ固有の正本仕様断片をまとめる入口。共通の CLI 基盤や横断仕様ではなく、このアプリで何を実装・修正・確認するかの判断基準を与える。
- 個別機能の外部挙動、起動条件、入出力、状態遷移、エラー時の扱いなど、アプリ仕様を読む前に対象を絞るために使う。

## Read this when
- このアプリの仕様、実装、テストを追加・修正するとき。
- このアプリに固有の起動条件、処理順、入出力、状態の持ち方、終了条件を確認したいとき。
- このアプリの個別文書のどれを先に読むべきか判断したいとき。

## Do not read this when
- 共通の CLI 基盤、ログ規約、エラー処理、索引更新、事前検証などの横断仕様だけを確認したいとき。
- このアプリとは無関係なサブコマンドや別機能の仕様を探したいとき。
- 既に読むべき個別仕様が分かっているとき。

## hash
- bdc7805b234dd99074d723cb4bcf4aa8c574225cdbd20f1e2cb1cc3f5d681c1d
