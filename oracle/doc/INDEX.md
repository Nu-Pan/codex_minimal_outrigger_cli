...
## Summary
- cmoc のアプリケーション全体に関わる正本仕様をまとめたディレクトリ。CLI 自動補完、Codex CLI 実行、ログ、doctor 前処理、feedback、prompt、session/run、サブコマンド、中断、通知などの仕様文書を扱う。個別仕様へ進むための横断的な入口となる。

## Read this when
- cmoc のアプリケーション横断仕様を確認するとき
- 対象機能の正本仕様がどの文書に定義されているかを探すとき
- CLI、Codex 実行、feedback、session/run、ログ、通知など複数の機能境界を確認するとき

## Do not read this when
- 単一の機能仕様が明確で、その正本文書を直接確認できるとき
- 実装配置やテスト実行手順など、仕様文書の一覧ではなく具体的な開発規則を確認したいとき
- アプリケーション仕様と無関係なリポジトリ共通設定や実装詳細だけを扱うとき

## hash
- 0c9bf5dec350723ee6603d229d9d560f59df7885b4d59c5dfe733a5dd036a381
