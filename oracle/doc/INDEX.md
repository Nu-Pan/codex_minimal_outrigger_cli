...
## Summary
- cmoc アプリケーションの正本仕様を構成する共通規則・状態管理・入出力・実行連携・フィードバック関連の文書群を扱う。
- サブコマンドごとの目的、引数、事前条件、実行手順、agent call、成果物、終了時の扱いを定義する仕様文書群への入口である。

## Read this when
- cmoc のアプリケーション仕様全体を把握したいとき
- 共通仕様または特定サブコマンドの正本仕様を探すとき
- 仕様に基づく実装変更や適合性確認を開始するとき

## Do not read this when
- 実装コードの具体的な構造や field の型・既定値を確認したいとき
- テストコードや検証手順だけを確認したいとき
- 対象の特定仕様文書が既に分かっており、そのファイルを直接読めるとき

## hash
- fc6e7a141c89e22ad6a6c3a7fe250c72cf71c06fe706d6ed3005cafa2153ba03
