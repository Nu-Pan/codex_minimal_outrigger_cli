...
## Summary
- cmoc の共通 runtime helper をまとめるパッケージ境界。個別の実装ではなく、複数モジュールから共有される補助機能の入口だけを示す。
- 下位の helper 群へ進む前に、この領域が runtime 共通処理のまとまりであることを確認したいときの案内先。
...
## hash
- 64e86cc4c8ce7c57ab535c5b9d26c4a782fe7735a04397202e4e7ecce8d293ea
