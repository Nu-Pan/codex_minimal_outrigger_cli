...
- `src/commons` は、cmoc 全体で共通利用する基盤モジュール群の入口です。
- `codex` の呼び出しラッパー、サブコマンド共通実行制御、共通エラー、`INDEX.md` 管理、リポジトリ操作、サブコマンドログ、タイムスタンプ、経過時間計測をまとめて案内します。
...
- `src/commons` 配下の共通モジュール群をまとめて把握し、どのファイルへ進むべきかを整理したいとき。
...
- 0e05319e68af18af91d997f891a23280f09a6cd17e5d290fc347f6b6c2f1b482
