...
## Summary
- `commons` 配下で共有される実行時補助機能の入口。個別 helper の詳細ではなく、共有 runtime helper 群の境界だけを示す。
- `cmoc` 実行時に複数モジュールから使う共通 helper の配置先や入口を確認するときに読む。
- 特定 helper の実装や CLI 固有処理を見たいときはここではなく、該当する下位要素やより直接の責務を持つ対象へ進む。
...
## hash
- 07c51d37e18a58ae7f1be218327dff4ec10a957920466709489500fa0b810584
