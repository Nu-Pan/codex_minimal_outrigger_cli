...
- `tests/test_subcommands.py` は、cmoc の主要サブコマンドと CLI 入口における決定論的な制御ロジックを検証する pytest テスト群の目次です。
...
- 85d9211e00d13de71d5b48a311dfc6ecc3f99d567d3404211f364bfd56d48531
