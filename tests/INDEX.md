...
- `cmoc init`、`cmoc branch`、`cmoc eval-oracle(s)`、`cmoc apply`、`cmoc merge` の実行フロー、補助関数、prompt、Structured Output schema を扱います。
...
- 89d3b1609ce3351891cec6c9896cca1a9bef1b10a1e84fb691d12c9d7442ab21
