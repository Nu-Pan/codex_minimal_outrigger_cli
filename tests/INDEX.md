...
- `tests/test_subcommands.py` は、`cmoc` の主要サブコマンドと CLI エントリポイント周辺の決定論的な制御ロジックを検証する pytest 群の目次です。
...
- d0394f4dc8cfd145e88096707686c74b778eede5fa26f4a8b4278f88ccb42010
