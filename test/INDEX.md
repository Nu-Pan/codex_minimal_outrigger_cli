...
- 完全な prompt に各標準断片が条件付きで含まれるか、または既定では含まれないかを確認したいとき。
- index entry や review 標準のような共通プロンプト部品を変更した後に、回帰確認の観点を把握したいとき。

## Do not read this when

- 個別の prompt 断片の実装内容そのものを確認したいだけで、テスト観点の整理が不要なとき。
- `complete_prompt` 以外の別フローや別階層のテストを探しているとき。
- このファイルで検証している包含条件やレンダリング結果がすでに分かっていて、直接本体や関連テストへ進むとき。

## hash

- f9efa9d56878269cd410d6194cebe344e947ef3b30f965ecb93a652107537b84
